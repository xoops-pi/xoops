<?php
// $Id: userinfo.php 2309 2008-11-09 05:45:57Z phppp $
//  ------------------------------------------------------------------------ //
...
if ( $isAdmin || ( is_object($xoopsUser) && $uid == $xoopsUser->getVar('uid') ) ) {
} else {
    $xoopsConfigUser = $config_handler->getConfigsByCat(XOOPS_CONF_USER);
    if (!array_intersect($groups, $xoopsConfigUser["allowed_groups"])) {
