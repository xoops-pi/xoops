<?php
// $Id: old_theme_functions.php 1948 2008-08-08 10:26:44Z phppp $
//  ------------------------------------------------------------------------ //
...
if (!function_exists('opentable')) {
    ...
    {
        trigger_error("Function '" . __FUNCTION__ . "' in '" . __FILE__ . "' is deprecated, should not be used any more", E_USER_NOTICE);
